import { IonContent, IonPage, IonHeader, IonToolbar, IonTitle, IonInput, IonButton } from "@ionic/react";
...
function Ai() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.post('http://localhost:3000/chat', { content: input });
        ...
        <IonPage>
            ...
            <IonContent className="chat-container">
                ...
                <div className="input-container">
                    ...
                    />
                    <IonButton onClick={onSubmit} color="primary">Send</IonButton>
                </div>
            </IonContent>
        </IonPage>
    );
